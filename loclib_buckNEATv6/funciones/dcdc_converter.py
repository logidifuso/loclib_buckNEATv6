...
#   -----------------------------------------------------------------------------------
    ...
    def eval_genomes_mp_buck_l1a_5i(self, genomes, config):
        ...
        genomes.fitness = BuckClass.fitness_buck_l1a_5i(self, net)
        return genomes.fitness

    def eval_genomes_single_buck_l1a_5i(self, genomes, config):
        # single process
        for genome_id, genome in genomes:
            # net = RecurrentNet.create(genome, config,1)
            net = neat.nn.FeedForwardNetwork.create(genome, config)
            genome.fitness = BuckClass.fitness_buck_l1a_5i(self, net)

    def fitness_buck_l1a_5i(self, net):
        """
    ...
    def run_buck_simulation_l1a_5i(self, net):
    ...
    def eval_genomes_mp_buck_l1a_5i_pid(self, genomes, config):

        net = neat.nn.FeedForwardNetwork.create(genomes, config)
        genomes.fitness = BuckClass.fitness_buck_l1a_5i_pid(self, net)
        return genomes.fitness

    def eval_genomes_single_buck_l1a_5i_pid(self, genomes, config):
        # single process
        for genome_id, genome in genomes:
            # net = RecurrentNet.create(genome, config,1)
            net = neat.nn.FeedForwardNetwork.create(genome, config)
            genome.fitness = BuckClass.fitness_buck_l1a_5i_pid(self, net)
    ...
    def run_buck_simulation_l1a_5i_pid(self, net):
    ...
    # Graficado de los resultados
    def plot_respuesta_buck_l1a_5i_pid(self, net, tinic=0, tfinal=None, view=False, filename='salida.svg'):
